...
if (isset($_GET["id"])) {
    ...
    $sqlValidasi = "SELECT COUNT(*) as count FROM t_prosesu_aimoruk WHERE id_staf = $id_municipiu";
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    window.location.href = 'Dadus_staff.php'; // Ganti 'municipiu.php' dengan halaman beranda Anda
                });
            });
        </script>";
    } else {
        // Jika tidak ada data terkait di tabel "Bainaka," lanjutkan dengan menghapus data dari tabel "Municipiu"
        $sql = "DELETE FROM t_staf WHERE id_staf = $id_municipiu";
