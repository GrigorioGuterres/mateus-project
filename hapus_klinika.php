...
if (isset($_GET["id"])) {
    ...
    $sqlValidasi = "SELECT COUNT(*) as count FROM t_prosesu_aimoruk WHERE id_klinika = $id_municipiu";
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    window.location.href = 'Dadus_klinik.php'; // Ganti 'municipiu.php' dengan halaman beranda Anda
                });
            });
        </script>";
    } else {
        // Jika tidak ada data terkait di tabel "Bainaka," lanjutkan dengan menghapus data dari tabel "Municipiu"
        $sql = "DELETE FROM t_klinika WHERE id_klinika = $id_municipiu";
