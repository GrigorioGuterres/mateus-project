...
if (isset($_GET["id"])) {
    ...
    $sqlValidasi = "SELECT COUNT(*) as count FROM detallu_aimoruk WHERE id_aimoruk = $id_municipiu";
        ...
        echo "<script>
            document.addEventListener('DOMContentLoaded', function() {
                Swal.fire({
                    ...
                    window.location.href = 'Dadus-aimoruk.php'; // Ganti 'municipiu.php' dengan halaman beranda Anda
                });
            });
        </script>";
    } else {
        // Jika tidak ada data terkait di tabel "Bainaka," lanjutkan dengan menghapus data dari tabel "Municipiu"
        $sql = "DELETE FROM t_aimoruk WHERE id_aimoruk = $id_municipiu";
